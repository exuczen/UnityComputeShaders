...
public class GPUPhysics : MonoBehaviour
{
    ...
    private void InitBuffers()
    {
        ...
        int numParticles = particlesArray.Length; //rigidBodyCount * particlesPerBody;
    ...
    private void InitShader()
    {
        ...
        int particleCount = particlesArray.Length; //rigidBodyCount * particlesPerBody;
        ...
        //groupsPerRigidBody = (rigidBodyCount + 7) >> 3;
        //groupsPerParticle = (particleCount + 7) >> 3;
